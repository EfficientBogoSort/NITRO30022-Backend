...
SECRET_KEY = 'django-insecure-qpiu#v6qh*)m)_$9ss$*7+77&k7yrxg1z4vu0ysk-b!1q39(22'
...
DATABASES = {
    ...
    'default': {
        ...
        'CLIENT': {
            'host': f"mongodb+srv://{os.getenv('MONGO_DB_USERNAME')}:{os.getenv('MONGO_DB_PASSWORD')}@{os.getenv('MONGO_DB_HOST')}/?retryWrites=true&w=majority"
        }
    }
}
...
AWS_S3_VERIFY = True
AWS_S3_ENDPOINT_URL = f"https://s3.{os.getenv('AWS_S3_REGION_NAME')}.amazonaws.com"
